...
mkdir -p "${PROJECT_ROOT}/build" "${PROJECT_ROOT}/graph"
...
dot -Tpng "${PROJECT_ROOT}/graph/callgraph.dot" -o "${PROJECT_ROOT}/build/callgraph.png"
...
dot -Tpng "${PROJECT_ROOT}/graph/callee_graph.dot" -o "${PROJECT_ROOT}/build/callee_graph.png"

echo "Graphs generated in the 'build' directory."
